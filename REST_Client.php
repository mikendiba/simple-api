...
{
  $app_info = file_get_contents('http://localhost/simple_api/api.php?action=get_app&id=' . $_GET["id"]);
...
{
  $app_list = file_get_contents('http://localhost/simple_api/api.php?action=get_app_list');
